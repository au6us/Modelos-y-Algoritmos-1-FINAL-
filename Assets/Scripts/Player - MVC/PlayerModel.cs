...
public class PlayerModel : MonoBehaviour
{
    ...
    public bool IsInvincible { get; private set; } // Para que no le peguen despu�s de romper escudo
    ...
    public void TakeDamage(int damageAmount)
    {
        ...
        if (IsInvincible) return; // Si es invencible, ignoramos el da�o
    ...
    // El propio Originator es quien conoce el tipo concreto del memento y se restaura a sí mismo.
